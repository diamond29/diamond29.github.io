...
async function main() {
  ...
  function getSpriteFromId(gidFromTileList) {
    ...
    return new Sprite(new Texture(resources["images/level/" + tileMetadataToUse.imageFileName].texture, new Rectangle(xPosition, yPosition, 32, 32)))
  }
